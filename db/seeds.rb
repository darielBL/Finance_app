...
# ============================================
# 1. CATEGORÍAS BASE (código existente - para TODOS los ambientes)
# ============================================
...
# ============================================
# 2. TASAS DE CAMBIO (SOLO en producción)
# ============================================

if Rails.env.production?
  puts "\n🌱 Sembrando tasas de cambio históricas en PRODUCCIÓN..."
  ...
  puts "\n🌱 ¡Semillas completadas en PRODUCCIÓN!"
  ...
  puts "\n⏭️  Tasas de cambio: omitidas (solo se cargan en producción)"
end